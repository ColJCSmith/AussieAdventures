...
})()(
  {
    ...
    3: [
      function (require, module, exports) {
        ...
        var object_to_query_param_string_1 = __importDefault(
          require("./object_to_query_param_string")
        );
        ...
        var exponential_backoff_with_jitter_1 = __importDefault(
        ...
        var Base = /** @class */ (function () {
          ...
          Base.prototype.makeRequest = function (options) {
            ...
            var url =
              ...
              "/" +
              this._id +
              get_1.default(options, "path", "/") +
              "?" +
              object_to_query_param_string_1.default(
                get_1.default(options, "qs", {})
              );
            var controller = new abort_controller_1.default();
            var requestOptions = {
              method: method,
              headers: this._getRequestHeaders(
                get_1.default(options, "headers", {})
              ),
            ...
            return new Promise(function (resolve, reject) {
              fetch_1
                .default(url, requestOptions)
                .then(function (resp) {
                  clearTimeout(timeout);
                  resp.statusCode = resp.status;
                  if (
                    resp.status === 429 &&
                    !_this._airtable._noRetryIfRateLimited
                  ) {
                    var numAttempts_1 = get_1.default(
                      options,
                      "_numAttempts",
                      0
                    );
                    ...
                    resp
                      ...
                      .then(function (body) {
                        var err =
                          _this._checkStatusForError(resp.status, body) ||
                ...
                .catch(function (err) {
                  clearTimeout(timeout);
                  err = new airtable_error_1.default(
                    "CONNECTION_ERROR",
                    err.message,
                    null
                  );
          ...
          Base.prototype._checkStatusForError = function (statusCode, body) {
            var _a = (body !== null && body !== void 0 ? body : { error: {} })
                .error,
              error = _a === void 0 ? {} : _a;
            var type = error.type,
              message = error.message;
            if (statusCode === 401) {
              return new airtable_error_1.default(
              ...
              return new airtable_error_1.default(
                type !== null && type !== void 0 ? type : "UNEXPECTED_ERROR",
                message !== null && message !== void 0
                  ? message
          ...
          Base.createFunctor = function (airtable, baseId) {
            ...
            forEach_1.default(
              ["table", "makeRequest", "runAction", "getId"],
              function (baseMethod) {
        ...
        function callbackToPromise(fn, context, callbackArgIndex) {
          ...
          return function () {
            ...
            if (callbackArgIndex === void 0) {
              ...
              thisCallbackArgIndex =
                arguments.length > 0 ? arguments.length - 1 : 0;
            } else {
    ...
    6: [
      function (require, module, exports) {
        ...
        var internal_config_json_1 = __importDefault(
          require("./internal_config.json")
        );
        // "Full Jitter" algorithm taken from https://aws.amazon.com/blogs/architecture/exponential-backoff-and-jitter/
        function exponentialBackoffWithJitter(numberOfRetries) {
          var rawBackoffTimeMs =
            internal_config_json_1.default.INITIAL_RETRY_DELAY_IF_RATE_LIMITED *
            Math.pow(2, numberOfRetries);
          var clippedBackoffTimeMs = Math.min(
            internal_config_json_1.default.MAX_RETRY_DELAY_IF_RATE_LIMITED,
            rawBackoffTimeMs
          );
      ...
      function (require, module, exports) {
        ...
        var HttpHeaders = /** @class */ (function () {
          ...
          HttpHeaders.prototype.toJSON = function () {
            var result = {};
            forEach_1.default(this._headersByLowercasedKey, function (
              headerDefinition,
              lowercasedKey
            ) {
              var headerKey;
    ...
    11: [
      ...
      { "lodash/forEach": 167, "lodash/isArray": 173, "lodash/isNil": 179 },
    ],
    12: [
      function (require, module, exports) {
        "use strict";
    ...
    13: [
      function (require, module, exports) {
        ...
        var callback_to_promise_1 = __importDefault(
          require("./callback_to_promise")
        );
        ...
        function eachPage(pageCallback, done) {
          ...
          var inner = function () {
            _this._table._base.runAction("get", path, params, null, function (
              err,
              response,
              result
            ) {
              if (err) {
                ...
                var records = map_1.default(result.records, function (
                  recordJson
                ) {
    ...
    14: [
      function (require, module, exports) {
        ...
        exports.paramValidators = {
          fields: typecheck_1.default(
            typecheck_1.default.isArrayOf(isString_1.default),
            "the value for `fields` should be an array of strings"
          ),
          filterByFormula: typecheck_1.default(
            isString_1.default,
            "the value for `filterByFormula` should be a string"
          ),
          maxRecords: typecheck_1.default(
            isNumber_1.default,
            "the value for `maxRecords` should be a number"
          ),
          pageSize: typecheck_1.default(
            isNumber_1.default,
            "the value for `pageSize` should be a number"
          ),
          offset: typecheck_1.default(
            isNumber_1.default,
            "the value for `offset` should be a number"
          ),
          sort: typecheck_1.default(
            typecheck_1.default.isArrayOf(function (obj) {
              return (
                isPlainObject_1.default(obj) &&
                isString_1.default(obj.field) &&
                (obj.direction === void 0 ||
                  includes_1.default(["asc", "desc"], obj.direction))
              );
            }),
          ...
          view: typecheck_1.default(
            isString_1.default,
            "the value for `view` should be a string"
          ),
          cellFormat: typecheck_1.default(function (cellFormat) {
            return (
              isString_1.default(cellFormat) &&
              includes_1.default(["json", "string"], cellFormat)
            );
          }, 'the value for `cellFormat` should be "json" or "string"'),
          timeZone: typecheck_1.default(
            isString_1.default,
            "the value for `timeZone` should be a string"
          ),
          userLocale: typecheck_1.default(
            isString_1.default,
    ...
    15: [
      ...
      { "./callback_to_promise": 4, "lodash/assign": 163 },
    ],
    16: [
      function (require, module, exports) {
        "use strict";
        ...
        function runAction(
          ...
          var url =
            ...
            path +
            "?" +
            object_to_query_param_string_1.default(queryParams);
          var headers = {
          ...
          fetch_1
            ...
            .then(function (resp) {
              ...
              if (
                resp.status === 429 &&
                !base._airtable._noRetryIfRateLimited
              ) {
                var backoffDelayMs = exponential_backoff_with_jitter_1.default(
                  numAttempts
                );
      ...
      function (require, module, exports) {
        ...
        var Table = /** @class */ (function () {
          function Table(base, tableId, tableName) {
            ...
            this.name = tableName;
            // Public API
            this.find = callback_to_promise_1.default(
              this._findRecordById,
              this
            );
            this.select = this._selectRecords.bind(this);
            this.create = callback_to_promise_1.default(
              this._createRecords,
              this
            );
            this.update = callback_to_promise_1.default(
              this._updateRecords.bind(this, false),
              this
            );
            this.replace = callback_to_promise_1.default(
              this._updateRecords.bind(this, true),
              this
            );
            this.destroy = callback_to_promise_1.default(
              this._destroyRecord,
              this
            );
            // Deprecated API
            this.list = deprecate_1.default(
              this._listRecords.bind(this),
              "table.list",
              "Airtable: `list()` is deprecated. Use `select()` instead."
            );
            this.forEach = deprecate_1.default(
          ...
          Table.prototype._selectRecords = function (params) {
            ...
            if (isPlainObject_1.default(params)) {
              ...
              if (validationResults.errors.length) {
                var formattedErrors = map_1.default(
          ...
          Table.prototype._updateRecords = function (
            ...
            if (isArray_1.default(recordsDataOrRecordId)) {
              ...
              opts = isPlainObject_1.default(recordDataOrOptsOrDone)
                ? recordDataOrOptsOrDone
                : {};
          ...
          Table.prototype._listRecords = function (limit, offset, opts, done) {
            ...
            this._base.runAction(
              ...
              function (err, response, results) {
                ...
                var records = map_1.default(results.records, function (
                  recordJson
                ) {
          ...
          Table.prototype._forEachRecord = function (opts, callback, done) {
            ...
            var nextPage = function () {
              _this._listRecords(limit, offset, opts, function (
                err,
                page,
                newOffset
              ) {
    ...
    18: [
      ...
      { "lodash/includes": 171, "lodash/isArray": 173 },
    ],
    19: [
      function (require, module, exports) {
        "use strict";
          ...
          (function (_Emitter) {
            ...
            function AbortSignal() {
              ...
              _this2 = _possibleConstructorReturn(
                this,
                _getPrototypeOf(AbortSignal).call(this)
        ...
        function abortableFetchDecorator(patchTargets) {
          ...
          var _patchTargets = patchTargets,
            ...
            __FORCE_INSTALL_ABORTCONTROLLER_POLYFILL =
              _patchTargets$__FORCE === void 0 ? false : _patchTargets$__FORCE;
    ...
    28: [
      ...
      { "./_MapCache": 25, "./_setCacheAdd": 149, "./_setCacheHas": 150 },
    ],
    29: [
      function (require, module, exports) {
    ...
    47: [
      ...
      { "./_baseForOwn": 50, "./_createBaseEach": 94 },
    ],
    48: [
      function (require, module, exports) {
        /**
    ...
    53: [
      ...
      { "./_Symbol": 30, "./_getRawTag": 107, "./_objectToString": 145 },
    ],
    54: [
      function (require, module, exports) {
        /**
    ...
    55: [
      ...
      { "./_baseFindIndex": 48, "./_baseIsNaN": 61, "./_strictIndexOf": 159 },
    ],
    56: [
      function (require, module, exports) {
      ...
      { "./_baseGetTag": 53, "./isObjectLike": 182 },
    ],
    57: [
      function (require, module, exports) {
      ...
      { "./_baseIsEqualDeep": 58, "./isObjectLike": 182 },
    ],
    58: [
      function (require, module, exports) {
        var Stack = require("./_Stack"),
    ...
    64: [
      ...
      { "./_baseGetTag": 53, "./isLength": 177, "./isObjectLike": 182 },
    ],
    65: [
      function (require, module, exports) {
    ...
    66: [
      ...
      { "./_isPrototype": 126, "./_nativeKeys": 142 },
    ],
    67: [
      function (require, module, exports) {
        var isObject = require("./isObject"),
      ...
      { "./_isPrototype": 126, "./_nativeKeysIn": 143, "./isObject": 181 },
    ],
    68: [
      function (require, module, exports) {
    ...
    73: [
      ...
      { "./_overRest": 147, "./_setToString": 152, "./identity": 170 },
    ],
    74: [
      function (require, module, exports) {
      ...
      { "./_defineProperty": 96, "./constant": 165, "./identity": 170 },
    ],
    75: [
      function (require, module, exports) {
        /**
    ...
    89: [
      ...
      { "./_assignValue": 40, "./_baseAssignValue": 44 },
    ],
    90: [
      function (require, module, exports) {
        var copyObject = require("./_copyObject"),
      ...
      { "./_copyObject": 89, "./_getSymbols": 108 },
    ],
    91: [
      function (require, module, exports) {
        var copyObject = require("./_copyObject"),
      ...
      { "./_copyObject": 89, "./_getSymbolsIn": 109 },
    ],
    92: [
      function (require, module, exports) {
        var root = require("./_root");
    ...
    93: [
      ...
      { "./_baseRest": 73, "./_isIterateeCall": 122 },
    ],
    94: [
      function (require, module, exports) {
    ...
    97: [
      ...
      { "./_SetCache": 28, "./_arraySome": 39, "./_cacheHas": 79 },
    ],
    98: [
      function (require, module, exports) {
        var Symbol = require("./_Symbol"),
    ...
    101: [
      ...
      { "./_baseGetAllKeys": 52, "./_getSymbols": 108, "./keys": 188 },
    ],
    102: [
      function (require, module, exports) {
        var baseGetAllKeys = require("./_baseGetAllKeys"),
      ...
      { "./_baseGetAllKeys": 52, "./_getSymbolsIn": 109, "./keysIn": 189 },
    ],
    103: [
      function (require, module, exports) {
    ...
    104: [
      ...
      { "./_isStrictComparable": 127, "./keys": 188 },
    ],
    105: [
      function (require, module, exports) {
      ...
      { "./_baseIsNative": 62, "./_getValue": 111 },
    ],
    106: [
      function (require, module, exports) {
    ...
    120: [
      ...
      { "./_baseCreate": 46, "./_getPrototype": 106, "./_isPrototype": 126 },
    ],
    121: [
      function (require, module, exports) {
        /** Used as references for various `Number` constants. */
    ...
    133: [
      ...
      { "./_Hash": 22, "./_ListCache": 23, "./_Map": 24 },
    ],
    134: [
      function (require, module, exports) {
    ...
    152: [
      ...
      { "./_baseSetToString": 74, "./_shortOut": 153 },
    ],
    153: [
      function (require, module, exports) {
    ...
    158: [
      ...
      { "./_ListCache": 23, "./_Map": 24, "./_MapCache": 25 },
    ],
    159: [
      function (require, module, exports) {
        /**
    ...
    172: [
      ...
      { "./_baseIsArguments": 56, "./isObjectLike": 182 },
    ],
    173: [
      function (require, module, exports) {
        /**
    ...
    178: [
      ...
      { "./_baseIsMap": 59, "./_baseUnary": 77, "./_nodeUtil": 144 },
    ],
    179: [
      function (require, module, exports) {
        /**
    ...
    183: [
      ...
      { "./_baseGetTag": 53, "./_getPrototype": 106, "./isObjectLike": 182 },
    ],
    184: [
      function (require, module, exports) {
      ...
      { "./_baseIsSet": 63, "./_baseUnary": 77, "./_nodeUtil": 144 },
    ],
    185: [
      function (require, module, exports) {
        var baseGetTag = require("./_baseGetTag"),
      ...
      { "./_baseGetTag": 53, "./isArray": 173, "./isObjectLike": 182 },
    ],
    186: [
      function (require, module, exports) {
        var baseGetTag = require("./_baseGetTag"),
    ...
    187: [
      ...
      { "./_baseIsTypedArray": 64, "./_baseUnary": 77, "./_nodeUtil": 144 },
    ],
    188: [
      function (require, module, exports) {
      ...
      { "./_arrayLikeKeys": 36, "./_baseKeys": 66, "./isArrayLike": 174 },
    ],
    189: [
      function (require, module, exports) {
        var arrayLikeKeys = require("./_arrayLikeKeys"),
      ...
      { "./_arrayLikeKeys": 36, "./_baseKeysIn": 67, "./isArrayLike": 174 },
    ],
    190: [
      function (require, module, exports) {
        var arrayMap = require("./_arrayMap"),
      ...
      function (require, module, exports) {
        ...
        var Airtable = /** @class */ (function () {
          function Airtable(opts) {
            ...
            this.requestTimeout =
              opts.requestTimeout || defaultConfig.requestTimeout;
            if (!this._apiKey) {
